...
export async function resetDb(): Promise<void> {
  for (const table of ["audit_log", "sessions", "password_reset_tokens", "invitations", "legacy_migrations", "dfbnet_imports", "team_drafts", "team_rosters", "team_sync_versions", "match_events", "matches", "players", "tournaments", "teams", "memberships", "clubs", "users"]) {
